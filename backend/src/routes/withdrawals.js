...
export async function createWithdrawal(request, env) {
    try {
        ...
        // Notify admin via email (Resend - same as forgot-password) - fire and forget, SMS removed per user request
        try {
