...
/* ================================================= */
/* LIST SUPABASE VIDEOS                              */
/* ================================================= */

export async function listSupabaseVideos(request, env) {
    ...
    try{
        ...
        const listUrl =
            `${credentials.url}/storage/v1/object/list/${bucket}`;
            ...
            return Response.json(
                {
                    ...
                    error:
                    "Failed to list Supabase videos",
        ...
        const videos =
            ...
            .map(file => {
                ...
                const publicUrl =
                    `${credentials.url}/storage/v1/object/public/${bucket}/${encodeURIComponent(file.name)}`;
